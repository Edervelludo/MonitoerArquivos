...
Namespace AACDRJ.DAL
    ...
    Public Class tipoFaturamentoOperadorDAL
        ...
        Public Function SelecionatipoFaturamentoOperadorDUV(ByVal DUV As String) As DataTable

            Dim sql = "Select * from aacdrj_tiposfaturamentooperador where numeroDUV = @DUV"
        ...
        Public Function insert(ByVal tfop As tipoFaturamentoOperadorDTO) As String
            Dim sql As String = "INSERT INTO `aacdrj_tiposfaturamentooperador` ( " &
                                "`tipoFaturamentoOperador` , " &
                                "`numeroDUV`  " &
                                ") " &
                                "VALUES ( " &
                                "@tipoFaturamentoOperador, @numeroDUV)"
            ...
            Try
                ...
                cmd.Parameters.AddWithValue("@tipoFaturamentoOperador", tfop.tipoFaturamentoOperador)

                cmd.Parameters.AddWithValue("@numeroDUV", tfop.numeroDUV)
            ...
            Finally
                cnn.Close()
            End Try
            Return tfop.numeroDUV & "-> CNPJ: " & tfop.tipoFaturamentoOperador
        End Function
        ...
        Public Function delete(ByVal DUV As String) As Integer
            Dim sql As String = "delete from aacdrj_tiposfaturamentooperador" &
