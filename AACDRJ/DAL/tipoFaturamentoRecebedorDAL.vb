...
Namespace AACDRJ.DAL
    ...
    Public Class tipoFaturamentoRecebedorDAL
        ...
        Public Function SelecionatipoFaturamentoRecebedorDUV(ByVal DUV As String) As DataTable

            Dim sql = "Select * from aacdrj_tipoFaturamentoRecebedor where numeroDUV = @DUV"
        ...
        Public Function insert(ByVal tfag As tipoFaturamentoRecebedorDTO) As String
            Dim sql As String = "INSERT INTO `aacdrj_tipoFaturamentoRecebedor` ( " &
                                "`tipoFaturamentoRecebedor` , " &
                                "`numeroDUV`  " &
                                ") " &
                                "VALUES ( " &
                                "@tipoFaturamentoRecebedor, @numeroDUV)"
            ...
            Try
                ...
                cmd.Parameters.AddWithValue("@tipoFaturamentoRecebedor", tfag.tipoFaturamentoRecebedor)
            ...
            Finally
                cnn.Close()
            End Try
            Return tfag.numeroDUV & "-> CNPJ: " & tfag.tipoFaturamentoRecebedor
        End Function
        ...
        Public Function delete(ByVal DUV As String) As Integer
            Dim sql As String = "delete from aacdrj_tipoFaturamentoRecebedor" &
