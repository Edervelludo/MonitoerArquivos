...
Namespace AACDRJ.DAL
    ...
    Public Class tipoFaturamentoArmadorDAL
        ...
        Public Function SelecionatipoFaturamentoArmadorDUV(ByVal DUV As String) As DataTable

            Dim sql = "Select * from aacdrj_tipoFaturamentoArmador where numeroDUV = @DUV"
        ...
        Public Function insert(ByVal tfag As tipoFaturamentoArmadorDTO) As String
            Dim sql As String = "INSERT INTO `aacdrj_tipoFaturamentoArmador` ( " &
                                "`tipoFaturamentoArmador` , " &
                                "`numeroDUV`  " &
                                ") " &
                                "VALUES ( " &
                                "@tipoFaturamentoArmador, @numeroDUV)"
            ...
            Try
                ...
                cmd.Parameters.AddWithValue("@tipoFaturamentoArmador", tfag.tipoFaturamentoArmador)
            ...
            Finally
                cnn.Close()
            End Try
            Return tfag.numeroDUV & "-> CNPJ: " & tfag.tipoFaturamentoArmador
        End Function
        ...
        Public Function delete(ByVal DUV As String) As Integer
            Dim sql As String = "delete from aacdrj_tipoFaturamentoArmador" &
