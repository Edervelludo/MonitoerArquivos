...
Namespace AACDRJ.DAL
    ...
    Public Class agenteMaritimoDAL
        ...
        Public Function SelecionaagenteMaritimoCNPJ(ByVal CNPJ As String) As DataTable
            ...
            Dim sql = "Select * from aacdrj_agentemaritimo where cnpjAgenciaNavegacao = @CNPJ"
        ...
        Public Function insert(ByVal agencia As agenteMaritimoDTO) As String
            Dim sql As String = "INSERT INTO `aacdrj_agentemaritimo` ( " &
                                "`nomeAgencia` , " &
                                "`numeroDUV` , " &
                                "`cnpjAgenciaNavegacao` " &
                                ") " &
                                "VALUES ( " &
                                "@nomeAgencia, @numeroDUV, @cnpjAgenciaNavegacao)"
            ...
            Try
                ...
                cmd.Parameters.AddWithValue("@numeroDUV", agencia.numeroDUV)
            ...
            Finally
                cnn.Close()
            End Try
            Return agencia.numeroDUV & "-> CNPJ: " & agencia.cnpjAgenciaNavegacao
        End Function
        ...
        Public Function delete(ByVal DUV As String) As Integer
            Dim sql As String = "delete from aacdrj_agentemaritimo" &
